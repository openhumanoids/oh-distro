    ...
    typedef boost::shared_ptr<drc::affordance_plus_t> AffPlusPtr;  
      ...
      volatile bool _updatingAffordanceSelectionMenu;
		...
		private:
			...
			void handleAffordancePubButtonCircle3d(const Segmentation::FittingParams& fp,GeometricPrimitive primitive);
			...
			void handleAffordancePubButtonCube(const Segmentation::FittingParams& fp);
                        void handleAffordancePubButtonPointCloud(const Segmentation::FittingParams& fp, const std::string& type);
