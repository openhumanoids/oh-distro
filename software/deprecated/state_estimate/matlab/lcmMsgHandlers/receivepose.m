...
% ground_truth data
pose.utime = m.utime;
pose.P_l = [m.pose.translation.x;m.pose.translation.y;m.pose.translation.z];
pose.V_l = [m.twist.linear_velocity.x;m.twist.linear_velocity.y;m.twist.linear_velocity.z];
