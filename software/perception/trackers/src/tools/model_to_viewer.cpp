...
private:
  ...
  void moveCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr & cloud);
  void mirrorCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr & cloud);
...
void StatePub::mirrorCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr & cloud){
...
void StatePub::moveCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr & cloud){
