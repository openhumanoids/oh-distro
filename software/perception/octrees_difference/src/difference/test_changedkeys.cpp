...
int main(int argc, char** argv) {
  ...
  point3d point_on_surface (5.0,0.0,0.0);
  tree.insertRay(origin, point_on_surface);
  printChanges(tree);
  tree.resetChangeDetection();
  tree.updateNode(point3d(4.0,0.0,0.0), 2.0f);
  tree.updateNode(point3d(2.0,0.0,0.0), 2.0f);
  printChanges(tree);
  tree.resetChangeDetection();
  tree.updateNode(point3d(3.0, 0.0, 0.0), 0.0f);
  tree.updateNode(point3d(4.0, 0.0, 0.0), 0.0f);
  tree.updateNode(point3d(1.0, 0.0, 0.0), 2.0f);
  printChanges(tree);
