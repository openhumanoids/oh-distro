...
int main() {
  // read pcd file
  std::string inFile = "/home/mfallon/drc-testing-data/terrain/tilted-steps.pcd";
  Eigen::Vector3f origin(0.248091, 0.012443, 1.806473);
  Eigen::Vector3f lookDir(0.837001, 0.019831, -0.546842);

  inFile = "/home/mfallon/drc-testing-data/terrain/terrain_med.pcd";
  origin << -0.028862, -0.007466, 0.087855;
  lookDir << 0.999890, -0.005120, -0.013947;

  inFile = "/home/mfallon/drc-testing-data/terrain/terrain_close_rect.pcd";
