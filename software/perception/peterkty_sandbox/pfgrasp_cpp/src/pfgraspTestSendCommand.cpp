...
int main(){
  ...
  perception::pfgrasp_command_t msg_out;
  ...
  while(1) {
      ...
      switch (k){
      case 's':
        msg_out.command = perception::pfgrasp_command_t::START;
        std::cout << "pushed s: START" << std::endl;
        break;
      case 'q':
        msg_out.command = perception::pfgrasp_command_t::STOP;
        std::cout << "pushed q: STOP" << std::endl;
        break;
      case 'g':
        msg_out.command = perception::pfgrasp_command_t::RUN_ONE_ITER;
        std::cout << "pushed g: RUN_ONE_ITER" << std::endl;
        break;
      case 'r':
        msg_out.command = perception::pfgrasp_command_t::RESTART;
