...
rgbd2file::rgbd2file(lcm_t* publish_lcm,lcm_t* subscribe_lcm):
...
void rgbd2file::kframe_handler(const kinect_frame_msg_t *msg){
  cout << "got kinect\n";
...
*/
  ...
  current_poseT.pose.translation() << 0,0,0;
  Eigen::Quaterniond m;
