#ifndef rgbd2file_hpp_
#define rgbd2file_hpp_
...
class rgbd2file{
  public:
    rgbd2file(lcm_t* publish_lcm,lcm_t* subscribe_lcm);
  ...
  private:
    ...
    static void kframe_handler_aux(const lcm_recv_buf_t* rbuf,
                                ...
                                void* user_data){
      ((rgbd2file *) user_data)->kframe_handler(msg);
    }
...
static void pointcloud_handler_aux(const lcm_recv_buf_t* rbuf,
                                ...
                                void* user_data) {
      ((rgbd2file *) user_data)->pointcloud_handler(msg);
    }
