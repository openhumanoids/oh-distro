...
void
StereoOdometry::decode_image(const drc_stereo_image_t * msg)
{
  // extract image data
...
//  switch (msg->pixelformat) {
  ...
  std::copy(msg->left.data , msg->left.data+msg->left.size  , _image_left_buf);
  std::copy(msg->right.data, msg->right.data+msg->right.size , _image_right_buf);
  //break;
...
void
StereoOdometry::image_handler(const drc_stereo_image_t *msg)
{
...
//                             StereoOdometry::image_handler_aux, this);
  drc_stereo_image_t_subscribe(_subscribe_lcm, image_channel.c_str(),
                             StereoOdometry::image_handler_aux, this);
