...
namespace visualization_utils
{
   ...
   inline static drc::traj_opt_constraint_t get_desired_foot_motion_traj_constraint(int64_t last_state_msg_timestamp, string robot_name,
    ...
    inline static void get_endpose_search_constraints_from_sticky_foot(StickyFootStruc &footstruc,OtdfInstanceStruc& obj, KDL::Frame& T_world_body_desired, bool to_future_state,
                                                      bool end_state_only,
