...
namespace opengl {
  ...
  public:
    ...
    void mouse_move( int x, int y, mouse_button_t mouseButton );  
    void mouse_press( int x, int y, mouse_button_t mouseButton );
    void mouse_release( int x, int y, mouse_button_t mouseButton );
