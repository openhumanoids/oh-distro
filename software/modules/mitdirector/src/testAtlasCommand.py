...
def drakePoseToQPInput(pose, velocity, atlasVersion=5, useValkyrie=True, useConstrainedDofs=False, fixedBase=False,
    ...
    polynomialMatrixMsg = lcmUtilsMIT.encodePolynomialVector(coefficientMatrix)
...
class JointCommandPanel(object):
    ...
    def __init__(self, robotSystem):
        ...
        uifile = QtCore.QFile(os.path.join(os.path.dirname(__file__), '../ui/ddJointCommandPanel.ui'))
