...
# takktile_node.py
#
# This is a new program based on the original takktile_udp.py program
# from TakkTile Inc.  This version imports LCM and publishs the data
# on an LCM topic.
#
...
if __name__ == '__main__':
    ...
    parser.add_argument("--side","-s",type=str,help="what side of the robot is the sensor mounted to",dest="side",
                        default='RIGHT')
