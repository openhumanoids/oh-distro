#ifndef RENDERER_CRAWLINGPLAN_HPP
#define RENDERER_CRAWLINGPLAN_HPP
...
void setup_renderer_crawling_plan(BotViewer *viewer, int render_priority, lcm_t *lcm, int operation_mode);

#endif //RENDERER_CRAWLINGPLAN_HPP
