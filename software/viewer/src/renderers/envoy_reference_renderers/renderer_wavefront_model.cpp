...
static void on_find_button(GtkWidget *button, RendererWheelchair *self)
{
...
static void wheelchair_free(BotRenderer *super)
{
...
static void wheelchair_draw(BotViewer *viewer, BotRenderer *super)
{
    RendererWheelchair *self = (RendererWheelchair*) super->user;
...
void add_wheelchair_model_renderer_to_viewer(BotViewer *viewer, int render_priority, 
