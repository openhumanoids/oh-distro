...
//std::cout<< "publishing ee_goals given four vicon markers" <<std::endl;
 ...
 //TODO: subscribe to robot_state_t on EST_ROBOT_STATE, and calculate current T_body_shoulder.
      T_body_Lshoulder.p[0]= 0.024; //atlas dimensions
      T_body_Lshoulder.p[1]= 0.221; //atlas dimensions
      T_body_Lshoulder.p[2]= 0.289; //atlas dimensions
      T_body_Lshoulder.M =  KDL::Rotation::RPY(0.0,0.0,0.0); // can vicon give orientation?

      T_body_Rshoulder.p[0]= 0.024;  //atlas dimensions
      T_body_Rshoulder.p[1]= -0.221; //atlas dimensions
      T_body_Rshoulder.p[2]= 0.289; //atlas dimensions
      T_body_Rshoulder.M =  KDL::Rotation::RPY(0.0,0.0,0.0); // can vicon give orientation?
  //body=utorso
...
//    T_world_Lendeffector.p[0]=0.547424;
//    T_world_Lendeffector.p[1]=0.221;
//    T_world_Lendeffector.p[2]=0.289;
...
//    T_world_Lshoulder.p[0]= 0.024;
//    T_world_Lshoulder.p[1]= 0.221;
//    T_world_Lshoulder.p[2]= 0.289;
 ...
 std::cout<< "T_body_Lendeffector: " << T_body_Lendeffector.p[0]<<" "<<  T_body_Lendeffector.p[1]<<" "<< T_body_Lendeffector.p[2]<<" "<<std::endl;

// T_body_Lendeffector.p[0]=0.347424;
// T_body_Lendeffector.p[1]=0.300125;
// T_body_Lendeffector.p[2]=0.0480499;
