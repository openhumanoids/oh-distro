...
class Handler 
{
    public:
        ...
        void SimpleApproach(const lcm::ReceiveBuffer* rbuf, const std::string& chan, const teleop::fourmarkers_t* msg)
        {
            ...
            markers.LEndeffector = create_marker(msg->Marker_LeftHand_a);
            markers.REndeffector = create_marker(msg->Marker_RightHand_a);
            markers.LShoulder = create_marker(msg->Marker_LeftShoulder_a);
            markers.RShoulder = create_marker(msg->Marker_RightShoulder_a);
