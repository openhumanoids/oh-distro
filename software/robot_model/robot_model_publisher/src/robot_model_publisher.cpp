...
void getHandConfiguration(std::vector<std::string> joint_names, int8_t &left_hand, int8_t &right_hand){
  ...
  }else if(find(joint_names.begin(), joint_names.end(), "left_finger_1_link_0" ) != joint_names.end()){
  ...
  }else if(find(joint_names.begin(), joint_names.end(), "right_finger_1_link_0" ) != joint_names.end()){
