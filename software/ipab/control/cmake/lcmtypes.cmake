...
if (LCM_FOUND)
  set(LCMGEN_DIR ${CMAKE_CURRENT_BINARY_DIR}/lcmgen)
  set(LCMTYPES_DIR ${LCMGEN_DIR}/lcmtypes)
...
function(lcmtypes_build_c)
  ...
  if (LCMTYPES_C_SOURCEFILES)
    ...
    set(__agg_h_fname "${LCMTYPES_DIR}/${LCMTYPES_C_AGGREGATE_HEADER}.h")
    file(WRITE "${__agg_h_fname}"
    	       "#ifndef __lcmtypes_${LCMTYPES_C_AGGREGATE_HEADER}_h__\n"
	       "#define __lcmtypes_${LCMTYPES_C_AGGREGATE_HEADER}_h__\n\n")
    foreach(c_file ${LCMTYPES_C_SOURCEFILES})
      string(REGEX REPLACE ".c$" ".h" h_file ${c_file})
      file(RELATIVE_PATH __tmp_path ${LCMGEN_DIR} ${h_file})
      file(APPEND "${__agg_h_fname}" "#include \"${__tmp_path}\"\n")
      get_filename_component(__tmp_dir ${__tmp_path} PATH)
      install(FILES ${h_file} DESTINATION "include/${__tmp_dir}")
...
function(lcmtypes_build_cpp)
  ...
  if (LCMTYPES_CPP_HEADERFILES)
    ...
    set(__agg_hpp_fname "${LCMTYPES_DIR}/${LCMTYPES_CPP_AGGREGATE_HEADER}.hpp")
    file(WRITE ${__agg_hpp_fname} 
    	       "#ifndef __lcmtypes_${LCMTYPES_CPP_AGGREGATE_HEADER}_hpp__\n"
	       "#define __lcmtypes_${LCMTYPES_CPP_AGGREGATE_HEADER}_hpp__\n\n")
    foreach(hpp_file ${LCMTYPES_CPP_HEADERFILES})
      file(RELATIVE_PATH __tmp_path ${LCMGEN_DIR} ${hpp_file})
      file(APPEND ${__agg_hpp_fname} "#include \"${__tmp_path}\"\n")
      get_filename_component(__tmp_dir ${__tmp_path} PATH)
      install(FILES ${hpp_file} DESTINATION "include/${__tmp_dir}")
    endforeach()
    ...
    install(FILES ${__agg_hpp_fname} DESTINATION include/lcmtypes)
