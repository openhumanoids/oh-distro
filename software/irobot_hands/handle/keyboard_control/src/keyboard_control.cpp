...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher control_pub = n.advertise<handle_msgs::HandleControl>("/handle/control", 1);
    ros::Publisher calibrate_pub = n.advertise<std_msgs::Empty>("/handle/calibrate", 1);
    ros::Publisher control_pub2 = n.advertise<handle_msgs::HandleControl>("/handle/control2", 1);
    ros::Publisher calibrate_pub2 = n.advertise<std_msgs::Empty>("/handle/calibrate2", 1);
