...
bool dist_tactile_good[3][10];
bool prox_tactile_good[3][12];
bool dist_flexure_good[3][4];
bool prox_flexure_good[3][4];
bool encoder_good[3];
bool dist_accel_good[3];
bool prox_accel_good[3];
