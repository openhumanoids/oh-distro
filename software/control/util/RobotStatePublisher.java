...
public class RobotStatePublisher
{
    ...
    public RobotStatePublisher(String robot_name, String[] joint_name)
    {
    ...
    public void publish(double t, double[] x, String channel) // use doubles here for compatibility w/ matlab
    {
      LCM lcm = LCM.getSingleton();
      msg.utime = (long)(t*100000);
