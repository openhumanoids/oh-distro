function [r_left,r_right] = createIrobotManips()
  dt=0.001;
  ...
  drc_path=getenv('DRC_PATH');
    ...
    filelocation=[drc_path '/models/mit_gazebo_models/mit_robot_hands/drake_urdfs/irobot_hand_drake_left.urdf'];
    ...
    filelocation=[drc_path '/models/mit_gazebo_models/mit_robot_hands/drake_urdfs/irobot_hand_drake_right.urdf'];
