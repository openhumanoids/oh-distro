...
lcmcoder = JLCMCoder(drc.control.RobotStateCoder(robot_name, joint_names, true));
joint_names
...
plan_publisher = drc.control.RobotPlanPublisher(robot_name, joint_names, true, 'CANDIDATE_ROBOT_PLAN', options.num_knot_points);
