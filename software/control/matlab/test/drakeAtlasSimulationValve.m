function drakeAtlasSimulationValve(atlas_version)
%NOTEST
...
r_hands = r_hands.addRobotFromURDF([getDrakePath(), '/examples/Atlas/urdf/simple_valve_wall.urdf'], [1; 0.0; 0]);
r_hands = compile(r_hands);
...
broadcast_opts.publish_imu = 0; % change if you want state_est here,
                                % keeping off for speed right now
