...
intercept_plans = QPReactiveRecoveryPlan.getInterceptPlans(foot_states, 'right', foot_vertices, reachable_vertices, r_ic, omega, 10);
best_plan = QPReactiveRecoveryPlan.chooseBestIntercept(intercept_plans);
pp = QPReactiveRecoveryPlan.swingTraj(best_plan, foot_states.(best_plan.swing_foot));
