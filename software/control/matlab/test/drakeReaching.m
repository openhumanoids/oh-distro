...
for i=1:length(ts)
  t = ts(i);
  if (i>1)
    [q_seed,q_nom,constraint,ikwrapoptions] = inverseKinWrapup(r,q(:,i-1), ...
      rfoot_ind,[0;0;0],rfoot_pos, ...
      lfoot_ind,[0;0;0],lfoot_pos, ...
      rhand_ind,[0;0;0],rhand_traj.eval(t), ...
      lhand_ind,[0;0;0],lhand_traj.eval(t),options,true);
    q(:,i) = inverseKin(r,q_seed,q_nom,constraint{:},ikwrapoptions);
