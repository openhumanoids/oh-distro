...
logfile = strcat(getenv('DRC_PATH'),'/../logs/lcmlog-2013-11-22.00_vicon');
...
hand_markers = vicon_data_struct{3}.data;
...
R = rpy2rotmat([-1.4192;-4.0072; 1.6042]);
avg_range = 0;
...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131122(params,false), 6, torso_data, hand_body, @rightHandMarkerPos_20131122, 12, hand_data);
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
%%
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131122(params,true), 0, torso_data, hand_body, @noPointsFun, 0, zeros(3,0,length(t_sample)));
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_fs, joint_indices,torso_body,@(params) torsoMarkerPos_20131122(params,true), 0, torso_data, hand_body, @rightHandMarkerPos_20131122, 12, hand_data,struct('search_floating',false));
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
handpts = r.forwardKin(kinsol,hand_body,rightHandMarkerPos_20131122(body2_params));
torsopts = r.forwardKin(kinsol,torso_body,torsoMarkerPos_20131122(body1_params,true));
% data 3 = function 4
...
[~, ~, ~, floating_states_check, residual_check, info_check, J_check, body1_resids_check, body2_resids_check] = ...
  jointOffsetCalibration(r, q_check, [],torso_body,@(params) torsoMarkerPos_20131122(params,true), 0, torso_check, hand_body, @(params) rightHandMarkerPos_20131122(body2_params,true), 0, hand_check);
