...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131123(params,false), 6, torso_data, hand_body, @leftHandMarkerPos_20131123, 12, hand_data);
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
%%
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131123(params,true), 0, torso_data, hand_body, @noPointsFun, 0, zeros(3,0,length(t_sample)));
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_fs, joint_indices,torso_body,@(params) torsoMarkerPos_20131123(params,true), 0, torso_data, hand_body, @leftHandMarkerPos_20131123, 12, hand_data,struct('search_floating',false));
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
handpts = r.forwardKin(kinsol,hand_body,leftHandMarkerPos_20131123(body2_params));
