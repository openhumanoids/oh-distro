...
hand_markers = vicon_data_struct{5}.data;
...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@torsoMarkerPos_20131024, 6, torso_data, hand_body, @rightHandMarkerPos_20131024, 12, hand_data);
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
%%
% [dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
%   jointOffsetCalibration(r, q_data, joint_indices,torso_body,@torsoMarkerPos_20131024, 6, torso_data, hand_body, @noPointsFun, 0, zeros(3,0,13));
% dq = unwrap([0;dq]);
% dq = dq(2:end);
% dq*180/pif
%%
...
handpts = r.forwardKin(kinsol,hand_body,rightHandMarkerPos_20131024(body2_params));
torsopts = r.forwardKin(kinsol,torso_body,torsoMarkerPos_20131024(body1_params));
% data 3 = function 4
