...
logfile = strcat(getenv('DRC_PATH'),'/../logs/lcmlog-2013-10-24.00');
t_offset = .15;
...
hand_markers = vicon_data_struct{6}.data;
...
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131024(params,true), 0, torso_data, hand_body, @leftHandMarkerPos_20131024, 12, hand_data);
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
...
%%
[dq, body1_params, body2_params, floating_states, residuals, info, J, body1_resids, body2_resids] = ...
  jointOffsetCalibration(r, q_data, joint_indices,torso_body,@(params) torsoMarkerPos_20131024(params,true), 0, torso_data, hand_body, @noPointsFun, 0, zeros(3,0,8));
dq = unwrap([0;dq]);
dq = dq(2:end);
dq*180/pi
%%
...
% b2(2) = -.095 - .104;
q(joint_indices,1) = q(joint_indices,1) + 0*dq;
% q(3) = q(3) + 1;constructVisualizer
% q = q*0;
% q(6) = pi/2;
v.draw(0,q);
kinsol = r.doKinematics(q);
handpts = r.forwardKin(kinsol,hand_body,leftHandMarkerPos_20131024(body2_params));
torsopts = r.forwardKin(kinsol,torso_body,torsoMarkerPos_20131024(body1_params,true));
% data 3 = function 4
...
[~, ~, ~, floating_states_check, residual_check, info_check, J_check, body1_resids_check, body2_resids_check] = ...
  jointOffsetCalibration(r, q_check, [],torso_body,@(params) torsoMarkerPos_20131024(params,true), 0, torso_check, hand_body, @(params) rightHandMarkerPos_20131024(body2_params,true), 0, hand_check);
