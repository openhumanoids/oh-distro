classdef DRCManipMapStateMachine< handle
  ...
  methods
   ...
   function setMap(obj,xmap,affinds)
        ...
        l_hand_body = findLinkId(obj.robot,'l_hand+l_hand_point_mass');
        r_hand_body = findLinkId(obj.robot,'r_hand+r_hand_point_mass');
        l_foot_body = findLinkId(obj.robot,'l_foot');
        r_foot_body = findLinkId(obj.robot,'r_foot');
        pelvis_body = findLinkId(obj.robot,'pelvis');
