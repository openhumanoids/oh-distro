classdef AtlasFootOffset < DRCPlanner
  ...
  methods
    ...
    function plan(obj, data)
        ...
        fk_pos.right = forwardKin(obj.biped,kinsol,obj.biped.foot_bodies_idx.right,[0;0;0],1);
        fk_pos.left = forwardKin(obj.biped,kinsol,obj.biped.foot_bodies_idx.left,[0;0;0],1);
