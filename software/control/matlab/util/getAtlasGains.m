...
k_f_p.l_leg_hpy = 0.02; % 01-31-14, f+v
k_f_p.l_leg_kny = 0.02; % 01-31-14, f+v
k_f_p.l_leg_aky = 0.3; % 01-31-14, f+v
k_f_p.l_leg_akx = 1.55; 
k_f_p.r_leg_hpz = 0.025; 
k_f_p.r_leg_hpx = 0.025; % 01-27-14, f+v 
k_f_p.r_leg_hpy = 0.02; % 01-31-14, f+v 
k_f_p.r_leg_kny = 0.02; % 01-31-14, f+v 
k_f_p.r_leg_aky = 0.3; % 01-31-14, f+v 
k_f_p.r_leg_akx = 1.7; 
...
ff_qd.l_leg_hpy = 0.1; % 01-31-14, f+v 
ff_qd.l_leg_kny = 0.1; % 01-31-14, f+v     
ff_qd.l_leg_aky = 0.6; % 01-31-14, f+v  
ff_qd.l_leg_akx = 1.25; 
ff_qd.r_leg_hpz = 0.1; 
ff_qd.r_leg_hpx = 0.55; % 01-27-14, f+v
ff_qd.r_leg_hpy = 0.1; % 01-31-14, f+v 
ff_qd.r_leg_kny = 0.1; % 01-31-14, f+v 
ff_qd.r_leg_aky = 0.6; % 01-31-14, f+v    
...
ff_qd_d.l_leg_hpy = 2.0; % 01-31-14, f+v
ff_qd_d.l_leg_kny = 2.0; % 01-31-14, f+v
ff_qd_d.l_leg_aky = 40.0; % 01-31-14, f+v
ff_qd_d.l_leg_akx = 0.0;
ff_qd_d.r_leg_hpz = 0.2;
ff_qd_d.r_leg_hpx = 0.5; % 01-27-14, f+v
ff_qd_d.r_leg_hpy = 2.0; % 01-31-14, f+v 
ff_qd_d.r_leg_kny = 2.0; % 01-31-14, f+v
ff_qd_d.r_leg_aky = 40.0; % 01-31-14, f+v
