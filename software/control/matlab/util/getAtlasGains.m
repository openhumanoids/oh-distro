...
k_q_p(l_arm_elx) = 15.0; % 11-14-13 seems sticky
...
k_q_p(r_arm_elx) = 15.0; % 11-14-13 seems sticky
...
k_qd_p(l_arm_elx) = 2.5; % 11-14-13--yikes
...
k_qd_p(r_arm_elx) = 1.5; % 11-13-13--yikes
