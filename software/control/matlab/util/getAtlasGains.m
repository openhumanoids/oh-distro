...
k_q_p.l_leg_hpx = 30.0 * 0.1;
k_q_p.l_leg_hpy = 60.0 * 0.1;
...
k_qd_p.back_bkx  = 0.0;
k_qd_p.neck_ay   = 0.1;
k_qd_p.l_leg_hpz = 0.0 * 0.1;
k_qd_p.l_leg_hpx = 0.0 * 0.1;
k_qd_p.l_leg_hpy = 0.1 * 0.1;
k_qd_p.l_leg_kny = 0.0 * 0.1;
k_qd_p.l_leg_aky = 2.5 * 0.1;
k_qd_p.l_leg_akx = 0.0 * 0.1;
