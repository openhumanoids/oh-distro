classdef ValPlanEval < bipedControllers.BipedPlanEval
  ...
  methods
    function obj = ValPlanEval(r, mode, varargin)
    ...
    % needs to be updated to deal with new qp_input msg type
    ...
    function run(obj)
      ...
      disp('ValPlanEval now listening');
