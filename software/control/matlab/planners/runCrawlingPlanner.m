  ...
  while waiting
    ...
    if (~isempty(x))
      ...
      if wRb(:,1)'*[0;0;1] > 0 % faceup
        ...
        [~,foot_spec(4).contact_pt_ind] = getContactPoints(getBody(r,findLinkInd(r,'r_foot')),'toe');
        [~,foot_spec(3).contact_pt_ind] = getContactPoints(getBody(r,findLinkInd(r,'l_foot')),'toe');
