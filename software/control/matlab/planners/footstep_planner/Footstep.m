classdef Footstep
  ...
  methods
    function obj = Footstep(biped, pos, id, body_idx, is_in_contact, pos_fixed, terrain_pts, infeasibility, walking_params, frames)
      if nargin < 10
        ...
        if body_idx == biped.foot_bodies_idx.right
          T = biped.foot_sole_transforms.right;
        elseif body_idx == biped.foot_bodies_idx.left
          T = biped.foot_sole_transforms.left;
        else
      ...
      obj.foot_bodies_idx_map = biped.foot_bodies_idx;
    ...
    function msg = to_footstep_t(obj)
      ...
      msg.id = obj.id;
      if obj.body_idx == obj.foot_bodies_idx_map.right
        msg.is_right_foot = true;
      elseif obj.body_idx == obj.foot_bodies_idx_map.left
  ...
  methods(Static=true)
    function footstep = from_footstep_t(msg, biped)
      ...
      if msg.is_right_foot
        body_idx = biped.foot_bodies_idx.right;
      else
        body_idx = biped.foot_bodies_idx.left;
      end
