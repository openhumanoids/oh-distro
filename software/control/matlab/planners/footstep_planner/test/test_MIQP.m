...
tic
nsteps = 19;
[steps, region_assignments] = footstepMIQP(r, foot_orig, goal_pos, nsteps, true, struct(request.params), safe_regions);
toc
...
tic
nsteps = 20;
seed = struct('steps', steps, 'region_assignments', region_assignments);
[steps, region_assignments] = footstepMIQP(r, foot_orig, goal_pos, nsteps, true, struct(request.params), safe_regions, seed);
toc
% profile viewer