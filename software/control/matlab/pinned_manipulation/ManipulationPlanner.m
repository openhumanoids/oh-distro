classdef ManipulationPlanner < handle
    ...
    methods
        ...
        function runPoseOptimization(obj,x0,ee_names,ee_loci,Indices)
            ...
            rfoot_const.contact_state = {ActionKinematicConstraint.STATIC_PLANAR_CONTACT*ones(1,num_r_foot_pts)};
            lfoot_const.contact_state = {ActionKinematicConstraint.STATIC_PLANAR_CONTACT*ones(1,num_l_foot_pts)};
            [q_out,snopt_info] = inverseKin(obj.r,q_guess,...
                ...
                ikoptions);
            rfoot_const = rmfield(rfoot_const,'contact_state');
            lfoot_const = rmfield(lfoot_const,'contact_state');
