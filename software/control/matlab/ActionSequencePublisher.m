classdef ActionSequencePublisher
	...
	methods
		function obj = ActionSequencePublisher(channel,kincons,x0)
      if nargin < 3
      ...
      obj.msg.num_contact_goals = length(kincons);
      obj = allocate(obj);
      for i = 1:obj.msg.num_contact_goals
        obj.msg.contact_goals(i) = kincon2goal(kincons(i));
      end
      obj.x0_nom = x0;
		end
