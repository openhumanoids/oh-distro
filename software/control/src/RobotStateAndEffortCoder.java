...
public class RobotStateAndEffortCoder implements drake.util.LCMCoder
{
    short m_num_joints;
    ...
    public RobotStateAndEffortCoder(String[] joint_name)
    {
    ...
    public drake.util.CoordinateFrameData decode(drc.robot_state_t msg)
    {
      ...
      fdata.val = new double[3*(m_num_joints+m_num_floating_joints)];
