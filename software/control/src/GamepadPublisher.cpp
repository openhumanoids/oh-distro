...
void GamepadPublisher::publish()
{
  ...
  if (rc == JOYSTICK_SUCCESS && (jse.type == gamepad_cmd_t::GAMEPAD_DISCRETE || jse.type == gamepad_cmd_t::GAMEPAD_CONTINUOUS)) {
...
{ 
  ...
  gamepad_cmd.type = static_cast<int8_t>(jse.type);
  gamepad_cmd.button = static_cast<int8_t>(jse.number);
  gamepad_cmd.utime = jse.time;
  switch (jse.type) {
    case gamepad_cmd_t::GAMEPAD_DISCRETE:
      process_discrete_event(jse, gamepad_cmd);
      break;
    case gamepad_cmd_t::GAMEPAD_CONTINUOUS:
...
void GamepadPublisher::process_discrete_event(js_event const & jse, gamepad_cmd_t & gamepad_cmd) const
{
  ...
  switch (jse.number) { 
    case gamepad_cmd_t::GAMEPAD_BUTTON_A:
      gamepad_cmd.button_a = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_B:
      gamepad_cmd.button_b = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_X:
      gamepad_cmd.button_x = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_Y:
      gamepad_cmd.button_y = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_START:
      gamepad_cmd.button_start = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_BACK:
      gamepad_cmd.button_back = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_LB:
      gamepad_cmd.button_lb = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_RB:
      gamepad_cmd.button_rb = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_JL:
      gamepad_cmd.button_thumbpad_left = value;
      break;
    case gamepad_cmd_t::GAMEPAD_BUTTON_JR:
