...
public class JointCommandCoder implements drake.util.LCMCoder 
{
    ...
    public JointCommandCoder(String robot_name, String[] joint_name, double[] Kp, double[] Kd) throws Exception
    {
    ...
    public JointCommandCoder(String robot_name, String[] joint_name) throws Exception
    {
