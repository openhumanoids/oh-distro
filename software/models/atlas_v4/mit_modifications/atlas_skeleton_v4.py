...
minimal_contact_urdf_path = "../components/atlas_v4_minimal_contact.urdf"
...
for inFile in glob("*.dae"):
    ...
    xpath_str = "//*[text()='../materials/textures/extremities_diffuse.png']"
...
mit.setLinkVisualRPY(urdf, 'r_lfarm', [0, math.pi, 0])
...
for foot_name, groups in contact_pts.iteritems():
    for group_name, pts in groups.iteritems():
        for pt in pts:
            mit.addContactPoint(urdf, foot_name, pt, group_name)
