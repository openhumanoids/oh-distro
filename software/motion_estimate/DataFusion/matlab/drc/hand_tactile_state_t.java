...
public final class hand_tactile_state_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    public float signal;
    ...
    public hand_tactile_state_t()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x9c83aab41327f418L;
    ...
    {
        if (classes.contains(drc.hand_tactile_state_t.class))
            return 0L;
 
        classes.add(drc.hand_tactile_state_t.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        outs.writeFloat(this.signal); 
 
        outs.writeByte( this.touched ? 1 : 0); 
    ...
    public hand_tactile_state_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public hand_tactile_state_t(DataInput ins) throws IOException
    {
    ...
    public static drc.hand_tactile_state_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        drc.hand_tactile_state_t o = new drc.hand_tactile_state_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.signal = ins.readFloat();
 
        this.touched = ins.readByte()!=0;
    ...
    public drc.hand_tactile_state_t copy()
    {
        drc.hand_tactile_state_t outobj = new drc.hand_tactile_state_t();
        outobj.utime = this.utime;
 
        outobj.signal = this.signal;
 
        outobj.touched = this.touched;
