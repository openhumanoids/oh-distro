...
public final class traj_opt_constraint_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    ...
    public traj_opt_constraint_t()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0xa0a8a47532f1c9b4L;
    ...
    {
        if (classes.contains(drc.traj_opt_constraint_t.class))
            return 0L;
 
        classes.add(drc.traj_opt_constraint_t.class);
    ...
    public traj_opt_constraint_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public traj_opt_constraint_t(DataInput ins) throws IOException
    {
    ...
    public static drc.traj_opt_constraint_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        drc.traj_opt_constraint_t o = new drc.traj_opt_constraint_t();
    ...
    public drc.traj_opt_constraint_t copy()
    {
        drc.traj_opt_constraint_t outobj = new drc.traj_opt_constraint_t();
