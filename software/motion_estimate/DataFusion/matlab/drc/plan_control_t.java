...
public final class plan_control_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(drc.plan_control_t.class))
            return 0L;
 
        classes.add(drc.plan_control_t.class);
    ...
    public static drc.plan_control_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        drc.plan_control_t o = new drc.plan_control_t();
    ...
    public drc.plan_control_t copy()
    {
        drc.plan_control_t outobj = new drc.plan_control_t();
