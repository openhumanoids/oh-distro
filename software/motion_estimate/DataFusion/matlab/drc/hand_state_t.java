...
public final class hand_state_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    ...
    {
        if (classes.contains(drc.hand_state_t.class))
            return 0L;
 
        classes.add(drc.hand_state_t.class);
    ...
    public hand_state_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public hand_state_t(DataInput ins) throws IOException
    {
    ...
    public static drc.hand_state_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        drc.hand_state_t o = new drc.hand_state_t();
    ...
    public drc.hand_state_t copy()
    {
        drc.hand_state_t outobj = new drc.hand_state_t();
