...
drc::atlas_raw_imu_t IMUStream::convertToLCMPacket(IMUPacket packet){
...
IMUPacket IMUStream::convertFromLCMPacket(drc::atlas_raw_imu_t msg, int64_t last_packet_utime, int64_t batch_utime){
      IMUPacket raw;
...
drc::atlas_raw_imu_batch_t IMUStream::convertToLCMBatch(IMUBatch batch){
...
IMUBatch IMUStream::convertFromLCMBatch(drc::atlas_raw_imu_batch_t* msg){
