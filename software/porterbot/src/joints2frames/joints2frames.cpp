// Publisher of bot_frames : bridges between joint angles and the viewer
// Jonathan Hechtbauer and Maurice Fallon Jan 2013
#include <stdio.h>
#include <inttypes.h>
#include <lcm/lcm.h>
#include <iostream>
...
joints2frames::joints2frames(boost::shared_ptr<lcm::LCM> &publish_lcm):
  ...
  l2f_list_ += "head","head_rightedhokuyo","r_hokuyo","l_hokuyo";
  // "head_hokuyo"
