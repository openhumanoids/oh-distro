...
#ifndef COLLISION_DETECTION_COLLISION_OBJECT_CONVEX_HULL_H
#define COLLISION_DETECTION_COLLISION_OBJECT_CONVEX_HULL_H
...
#endif /* COLLISION_DETECTION_COLLISION_OBJECT_CONVEX_HULL_H */
