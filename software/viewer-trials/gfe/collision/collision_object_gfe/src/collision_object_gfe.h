...
namespace collision {
  ...
  public:
    Collision_Object_GFE( std::string id = "N/A", kinematics::Atlas_Version atlas_version = kinematics::V4, collision_object_gfe_collision_object_type_t collisionObjectType = COLLISION_OBJECT_GFE_COLLISION_OBJECT_COLLISION );
    Collision_Object_GFE( std::string id, std::string xmlString, kinematics::Atlas_Version atlas_version = kinematics::V4, collision_object_gfe_collision_object_type_t collisionObjectType = COLLISION_OBJECT_GFE_COLLISION_OBJECT_COLLISION );
    Collision_Object_GFE( std::string id, std::string xmlString, collision_object_gfe_collision_object_type_t collisionObjectType = COLLISION_OBJECT_GFE_COLLISION_OBJECT_COLLISION, kinematics::Atlas_Version atlas_version = kinematics::V4 );
