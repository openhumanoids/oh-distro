#ifndef DRCSCROLLINGPLOTS_RENDERER_H_
#define DRCSCROLLINGPLOTS_RENDERER_H_
...
void drcscrollingplots_add_renderer_to_viewer(BotViewer* viewer, int priority,lcm_t* lcm);
