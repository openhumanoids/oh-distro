...
class PlanarHoverPlugin : public Controller
{

public:
  PlanarHoverPlugin(Entity *parent);
  virtual ~PlanarHoverPlugin();
...
private:
  ...
  ParamT<std::string> *XJointNameP;
  ParamT<std::string> *YJointNameP;
  ParamT<std::string> *thetaJointNameP;
  ParamT<std::string> *movingBaseNameP;
