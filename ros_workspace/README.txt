...
2) atlas_gazebo_plugins: Contains a plugin that transmits true_robot_state from gazebo. The gazebo plugin is generated as shared lib within atlas_gazebo_plugins/lib folder.  Must run rosmake within the atlas_gazebo_plugin folder. This is essential for atlas biped to be launched within gazebo. 
...
Run rosmake within this folder, generates an executable on ROS2LCM_translator/bin.
