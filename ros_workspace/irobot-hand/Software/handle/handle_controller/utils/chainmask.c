...
int main(int argc, char** argv)
{
    ...
    else
    {
        printf("\n\n");
        printf(" [255] All on\n");
        printf(" [  1] Only tactile palm\n");
        printf(" [  2] Only finger 1\n");
        printf(" [  4] Only finger 2\n");
        printf(" [  8] Only finger 3\n");
        printf(" [ 16] Only motors 1+2\n");
        printf(" [ 32] Only motors 3+4\n");
        printf("Common options:\n");
        printf(" [ 48] No Fingers, no tactile palm\n");
        printf(" [ 49] No Fingers\n");
        printf(" [ 62] No tactile palm\n");
        printf("Mask: ");
