...
#define TACT_PORTA_MASK 0x60
#define TACT_PORTB_MASK 0x0F
#define TACT_PORTC_MASK 0x02 //0x1E
//#define TACT_PORTE_MASK 0x0E
#define PORTC_MUX_MASK 0x1C
#define PORTC_MUX_SHIFT 0x02
#define PORTA_MUX_EN 0x40

#define TACT_TIMEOUT 96 //96=3ms  8.16=255us
...
int16_t pressureData[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
int16_t pressureDataOffset[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
int16_t pressureTempData[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];

// int16_t a0coeff[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
// int16_t b1coeff[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
// int16_t b2coeff[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
// int16_t c12coeff[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];

//float floatingPressureData[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
// uint16_t rawpressure[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
// uint16_t rawtemp[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];

uint8_t pressureCalibrated[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
uint16_t lastPressure[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
int16_t adjustedPressure[MAXIMUM_NUMBER_OF_TACTILE_SENSORS];
...
static void readTactSensor(uint8_t tactAddress);
...
// Set the appropriate chip select line
static void selectSensor(uint8_t tactAddress)
{
    uint8_t dummyRead;
