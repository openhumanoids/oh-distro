...
class Demo:
    ...
    def demo(self):
        ...
        home_msg.position[AtlasState.l_arm_shx] =  -1.2
        home_msg.position[AtlasState.r_arm_shx] =  1.2
        ...
        stand_prep_msg.position[AtlasState.l_arm_shx] =  -1.2
        stand_prep_msg.position[AtlasState.r_arm_shx] =  1.2
        # Publish and give time to take effect
        ...
        slight_movement_msg.position[AtlasState.neck_ry] = 1.0
        slight_movement_msg.position[AtlasState.l_arm_ely] = 0.2
        slight_movement_msg.position[AtlasState.l_arm_elx] = 0.2
        slight_movement_msg.position[AtlasState.r_arm_ely] = -0.2
        slight_movement_msg.position[AtlasState.r_arm_elx] = -0.2
        ...
        # Bump up kp_velocity to reduce the jerkiness of the transition
        slight_movement_msg.kp_velocity = [50.0] * self.NUM_JOINTS
        ...
        slight_movement_msg.k_effort[AtlasState.r_arm_elx] = 255
        slight_movement_msg.position[AtlasState.l_arm_shx] =  -1.2
        slight_movement_msg.position[AtlasState.r_arm_shx] =  1.2
        # Publish and give time to take effect
