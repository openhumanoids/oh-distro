...
def print_usage():
    ...
    print "  top row of letters    = cylindrical"
    print "  second row of letters = spherical"
    print "  third row of letters  = prismatic(T grasp)"
    print ""
    ...
    print "is commanded by pressing 'q'. For the right hand, press 'y'."
    print ""
